...
from vllm_ascend.model_loader.rfork.safety import ensure_no_rfork_session, shutdown_rfork_sessions
...
class NPUWorker(WorkerBase):
    ...
    def shutdown(self) -> None:
        ...
        if not shutdown_rfork_sessions(getattr(self, "vllm_config", None)):
            logger.warning("RFork session cleanup did not complete during worker shutdown.")
            return
