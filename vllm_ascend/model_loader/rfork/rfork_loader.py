...
def _build_rfork_compatibility_fingerprint(
    ...
    *,
    ...
    """Build the RFork v2 compatibility identity and return its SHA256 digest."""
    ...
    descriptor = {
        "protocol_version": RFORK_PROTOCOL_VERSION,
        "model_url": model_url,
        ...
        "role": {
            ...
            "kv_role": _canonicalize_fingerprint_value(kv_role),
